...
import type { SoldProperty } from "@/types/user";
...
interface PropertiesSoldListProps {
  properties: SoldProperty[];
  onPropertyClick?: (property: SoldProperty) => void;
  loading?: boolean;
};

const PropertiesSoldList: React.FC<PropertiesSoldListProps> = ({ 
  properties, 
  onPropertyClick,
  loading
}) => {
  // Log the properties data
  // console.log("PropertiesSoldList received properties:", properties);
  ...
  if (!properties || properties.length === 0) {
    return (
      <div className="text-center py-12 text-gray-500">
        ...
        <p className="text-lg font-medium">No properties sold yet</p>
        <p className="text-sm mt-1">Your sold properties will appear here</p>
      </div>
    );
  }
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-4 whitespace-nowrap min-w-0">
                    <div className="text-sm font-medium text-gray-900 truncate">{propertyPrice}</div>
                  </td>
      ...
      <div className="bg-gray-50 px-4 py-3 border-t border-gray-200">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
          <p className="text-xs text-gray-600">
            Showing <span className="font-semibold">{properties.length}</span> sold properties
          </p>
          {/* <div className="flex items-center gap-2">
...
export default PropertiesSoldList;